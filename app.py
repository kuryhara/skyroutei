"""
SkyRoute / 天途 v11 — Live Vulnerability-Aware Emergency Decision Agent
==================================================================
...
# =============================================================================
st.set_page_config(
    page_title="SkyRoute v11 | SkyTech CCO",
    page_icon="🛰️",
    layout="wide",
...
SKYROUTE_LOGO_DATA_URI = "data:image/png;base64,"
...
st.markdown(
    """
<div class="sr-footer">
SkyRoute / 天途 v11 · live vulnerability-aware emergency decision demonstrator.<br/>
