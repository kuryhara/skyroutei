"""
HERO AGENT — Human Equity & Efficiency Rescue Orchestrator
==========================================================
An AI Agent that helps emergency commanders select and continuously update rescue 
routes and dispatch priorities, redefining efficiency by prioritizing social 
...
# =============================================================================
st.set_page_config(
    page_title="HERO AGENT | Human Equity & Efficiency Rescue Orchestrator",
    page_icon="🛰️",
    layout="wide",
